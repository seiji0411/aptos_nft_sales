...
import {ALIENS, MINT_PRICE} from "../const";

export async function set_mint_price(creator: AptosAccount, client: AptosClient) {
    const create_candy_machine = {
        type: "entry_function_payload",
        function: ALIENS + "::aliens_core::set_mint_price",
        type_arguments: [],
        arguments: [
            MINT_PRICE,
        ]
    ...
    if (check_txn.success) {
        console.log('Mint price updated - Transaction Hash: ' + transactionRes.hash)
    } else {
